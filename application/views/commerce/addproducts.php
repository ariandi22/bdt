...
<form method="post" action="<?= base_url('commerce/upload_handler') ?>" enctype="multipart/form-data"">
<div class="panel panel-default pnl">
    ...
    <div class="panel-body">
        ...
        <div class="form-group col-md-12">
          <input class="form-control" type="text" name="code_product" value="<?php echo random_string('alnum', 21); ?>">
        </div>
