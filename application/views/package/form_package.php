...
<form method="post" action="<?= base_url('commerce/save_package') ?>" enctype="multipart/form-data"">
<div class="panel panel-default pnl">
    ...
    <div class="panel-body">
        ...
        <div class="form-group col-md-6">
            ...
            <select name="plane" class="selectpicker form-control">
		        <option selected="selected" disabled>--</option>
        ...
        <div class="form-group col-md-12">
          <input class="form-control" type="text" name="code_package" value="<?php echo random_string('alnum', 21); ?>">
        </div>
